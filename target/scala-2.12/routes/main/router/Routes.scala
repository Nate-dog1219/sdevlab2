...
// @DATE:Tue Feb 27 11:42:32 GMT 2018
...
class Routes(
  ...
  // @LINE:25
  private[this] lazy val controllers_HomeController_updateProductSubmit15_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("updateProductSubmit/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_updateProductSubmit15_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:25
    case controllers_HomeController_updateProductSubmit15_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_updateProductSubmit15_invoker.call(HomeController_0.updateProductSubmit(id))
      }
  }
}
